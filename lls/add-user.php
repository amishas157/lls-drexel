...
<?php
	if( isset( $_POST['submit'] ) )
	{
		...
		$user->linked_url= $_POST['linked_url'];
		$user->password= $_POST['password'];
		$user->position= $_POST['position'];
		$user->email= $_POST['email'];
		$user->create();
		redirect_to("mailbox/inbox?msg=User added successfully");
...
<head>
	...
	<title>LLSCT | Add New User</title>
	...
	<div class="panel-body">
		...
		<form role="form" id="form1" method="post" class="validate">
			...
			<div class="form-group" >
				...
				<br />
				<div class="col-sm-5">
				<input type="text" class="form-control"  name="first_name" data-validate="required" data-message-required="First Name is required for identification."/>  
				</div>
			</div>
			<br /><br /><br />
			...
			<div class="form-group" >
				...
				<br />
				<div class="col-sm-5">
				<input type="text" class="form-control" name="last_name" data-validate="required" data-message-required="Last Name is required for identification."  />
				</div>
			</div>
			<br /><br /><br />
			...
			<div class="form-group" >
				...
				<br />
				<div class="col-sm-5">
				<input type="password" class="form-control" name="password" data-validate="required,minlength[6],maxlength[20]" data-message-required="Initial password field is required. User can change it in future." />
				</div>
			</div>
			<br /><br /><br />
			...
			<div class="form-group" >
				...
				<br />
				<div class="col-sm-5">
				<input type="text" class="form-control" name="position" data-validate="required" data-message-required="This field is required." />
				</div>
			</div>
			<br /><br /><br />
			
			<div class="form-group" >
				<label for="field-1" class="control-label">Skype ID :</label>
				<br />
				<div class="col-sm-5">
				<input type="text" class="form-control" name="skype_id" data-validate="required" data-message-required="Skype ID is required for inter-organization communication." />
				</div>
			</div>
			<br /><br /><br />
			
			<div class="form-group" >
				<label for="field-1" class="control-label">LinkedIn Public URL : (Including <strong>https://</strong>)</label>
				<br />
				<div class="col-sm-5">
				<input type="text" class="form-control" name="linkedin_url" data-validate="required,url" data-message-required="Please enter a public URL of the intended user." />
				</div>
			</div>
			<br /><br /><br />
			...
			<div class="form-group" >
				...
				<br />
				<div class="col-sm-5">
				<input type="text" class="form-control" name="contact_no" data-validate="required,number,minlength[10]"/>
				</div>
			</div>
			<br /><br /><br />
			...
			<span>
							<button 
								type="button" 
								class="btn btn-blue" 
								onClick="window.location.assign('manage-user.php')" 
							>
								Manage User
							</button>
						</span>
...
<!-- List of current members starts... -->
<br /> <br />

<br /> <br />
<!-- List of current members ends... -->
