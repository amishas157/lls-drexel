...
<head>
	...
	<title>LLSCT | View Public Documents</title>
			...
			<ol class="breadcrumb bc-3">
				...
				<a href="index.html"><i class="entypo-home"></i>Home</a>
					...
					<li>
							...
							<a href="ui-panels.html">Documents</a>
					</li>
				<li class="active">
								...
								<?php
									foreach( $drive_data as $drive_datum )
									{
										...
										<a href="<?php echo $drive_datum->upload_dir . DS . $drive_datum->file_name; ?>" class="list-group-item">
											<span class="badge badge-info"> <?php echo $owner->get_full_name() ?></span>
